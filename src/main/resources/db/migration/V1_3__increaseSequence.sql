...
alter sequence protocols_protocol_id_seq restart with 4;
alter sequence events_event_id_seq restart with 15;
alter sequence games_game_id_seq restart with 4;